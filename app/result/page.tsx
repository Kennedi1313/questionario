    ...
    <>
        <div ref={ref} className="bg-white pt-28 px-5 min-h-screen h-full flex flex-col gap-6">
            ...
            <div className="flex flex-col w-full rounded-md p-2 md:p-8 gap-2">
                ...
                <p className="text-justify">Sendo o Repositório Institucional um ambiente voltado a uma instituição educacional, deve contemplar a missão e os objetivos da instituição que está vinculado. Para isso, a Arquitetura da Informação fornece diretrizes importantes para a melhoria do seu Repositório.
                </p>
            ...
            <div className="flex flex-col w-full rounded-md p-2 md:p-8 gap-2">
                ...
                <p className="text-justify">Sendo o Repositório Institucional um ambiente voltado a disponibilização da produção científica de uma instituição educacional, a disposição dos ícones que auxiliam na navegação, os ícones que indicam sinalizações para ajudar na tomada de decisão, o posicionamento da aba de busca, entre outros, você considera sua homepage deve ser fácil e interativa. Isso auxilia no acesso facilitado aos materiais científicos e na satisfatória experiência do usuário. Para isso, a Arquitetura da Informação fornece diretrizes importantes para a melhoria do seu Repositório.
                </p>
